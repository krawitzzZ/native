...
const initialState = fromJS({
  tabs: {
    index: 1,
    routes: [
      {key: 'PhotoTab', title: 'Take a photo'},
      {key: 'HomeTab', title: 'Home'},
      {key: 'VideoTab', title: 'Record a video'}
    ]
  },
  ...
  // Scenes for the `PhotoTab` tab.
  PhotoTab: {
    index: 0,
    routes: [{key: 'Photo', title: 'Photo here'}]
  },
  // Scenes for the `VideoTab` tab.
  VideoTab: {
    index: 0,
    routes: [{key: 'Video', title: 'Video here'}]
  }
});
